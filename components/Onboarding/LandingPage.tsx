      ...
      <div className="w-full max-w-2xl flex flex-col items-center gap-7 sm:gap-10">
        ...
        <div className="text-center space-y-3">
          ...
          <div className="flex flex-col items-center gap-2">
            <div className="flex items-center justify-center gap-6 sm:gap-10">
              ...
              >
                <img
                  src="/chao-zhang.jpg"
                  alt="Chao Zhang"
                  className="w-12 h-12 sm:w-14 sm:h-14 rounded-full object-cover ring-2 ring-white shadow-md group-hover:shadow-lg group-hover:scale-105 transition-all duration-200"
                />
            ...
            <p className="text-xs text-gray-400 tracking-wide uppercase">Cornell University</p>
          </div>
        </div>

        {/* Video */}
        <div className="w-full rounded-xl sm:rounded-2xl overflow-hidden border border-gray-100 shadow-md sm:shadow-lg">
          <iframe
        ...
        <div className="flex flex-col sm:flex-row gap-3 w-full sm:w-auto">
          <button
            onClick={onOpenTool}
            className="inline-flex items-center justify-center gap-2 px-7 py-3 rounded-xl bg-gray-900 text-white text-sm font-medium hover:bg-gray-700 transition-colors shadow-sm w-full sm:w-auto"
          >
          ...
          <Link
            href="/ier"
            className="inline-flex items-center justify-center gap-2 px-7 py-3 rounded-xl border border-gray-200 text-gray-700 text-sm font-medium bg-white hover:bg-gray-50 hover:border-gray-300 transition-colors shadow-sm w-full sm:w-auto"
          >
            <svg className="w-4 h-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2}>
